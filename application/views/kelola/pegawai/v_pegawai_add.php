...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'kode_pegawai','class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <?php
            echo button('send_form(document.faddmenugrup,"kelola/pegawai/show_addForm/","#divsubcontent")','Save','btn btn-success')." ";
            ?>
            </div>
        </div>
    </form>
