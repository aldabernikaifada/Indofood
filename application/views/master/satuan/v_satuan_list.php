        ...
        <div class="box box-primary">
          ...
          <tr>
            ...
            <?php
              ...
              ?>
              <a href="<?= site_url('master/satuan/delete/'.$row->id) ?>" class="btn btn-danger" onclick="return confirm('Anda Yakin Ingin Menghapus Satuan Ini ?')"><i class="fa fw fa-trash"></i></a>
